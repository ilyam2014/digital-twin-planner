declare global {
  ...
  const addProduct: typeof import('../../server/utils/db').addProduct
  ...
  const getProducts: typeof import('../../server/utils/db').getProducts
  const getProjects: typeof import('../../server/utils/db').getProjects
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/projects/digital-twin-planner/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/projects/digital-twin-planner/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getProducts, addProduct, getProjects } from 'C:/projects/digital-twin-planner/server/utils/db';